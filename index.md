...
This documentation covers features in the <a href="https://github.com/BasHamer/PossumLabs.Specflow.Core" target="_blank">PossumLabs.Specflow.Core</a> and <a href="https://github.com/BasHamer/PossumLabs.Specflow.Selenium" target="_blank">PossumLabs.Specflow.Selenium</a> projects. These projects extend Specflow to add support for variables, entities, and proxies. You can write tests for web applications using the Selenium features, and you can write tests for application programming interfaces (APIs) and enterprise service buses (ESBs) using the core functionality.
